...
var dayModule = (function () {
  ...
  function Day (data) {
    ...
    if (this.restaurants) this.restaurants = this.restaurants.map(attractionModule.create);
    if (this.activities) this.activities = this.activities.map(attractionModule.create);
